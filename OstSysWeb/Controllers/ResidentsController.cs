...
namespace OstSysWeb.Controllers
{
    public class ResidentsController : ApiController
    {
        ...
        public IHttpActionResult GetResident(string id)
        {
        ...
        public IHttpActionResult PostResident(Resident resident)
        {
            ...
            {
                if (ResidentExists(resident.Resident_ID))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = resident.Resident_ID }, resident);
        }
        ...
        {
            return db.Residents.Count(e => e.Resident_ID == id) > 0;
        }
    }
}